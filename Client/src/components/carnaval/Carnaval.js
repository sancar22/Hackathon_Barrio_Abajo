      ...
      <div className="row">
        <p className="textCar col-sm-4">
          <ul>
            ...
            por el río y que hoy siguen alegrando las comparsas. 
         </ul>
            <ul>Es uno de los atractivos más reconocidos de la ciudad y actualmente impulsa la
            recuperación patrimonial del sector a través de varios elementos de
                la identidad Barranquillera.</ul>
