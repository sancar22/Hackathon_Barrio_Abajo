  ...
  return (
   <body>  
    <div >
      ...
      <div>
         <Map scrollWheelZoom={false} className="map" center={[10.989941, -74.783702]} zoom={16}>
          <TileLayer
          ...
          <a href="#prueba">
          <Marker position={[10.988517, -74.778619]} icon={myIcon} onClick={executeScroll1}>
            <Popup>
              Aduana
            </Popup>
          </Marker>
          </a>
          <Marker position={[10.986303, -74.778472]} icon={myIcon1} onClick={executeScroll3}>
            <Popup>
              Museo del Caribe
            </Popup>
          </Marker>
          <Marker position={[10.992788, -74.787784]} icon={myIcon2} onClick={executeScroll4}>
            <Popup>
              La Casa del Carnaval
            </Popup>
          </Marker>
          <Marker position={[10.9893528, -74.7827108]} icon={myIcon3} onClick={executeScroll2}>
            <Popup>
              Los Murales
            </Popup>
          </Marker>
